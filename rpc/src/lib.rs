...
pub mod v1 {
    ...
    pub mod pool {
        pub use super::pb::{
            pool_rpc_client, CreatePoolRequest, DestroyPoolRequest, DiskInfo, GrowPoolRequest,
            ImportPoolRequest, ListPoolOptions, ListPoolsResponse, Pool, PoolAlert,
            PoolAlertStatus, PoolAlerts, PoolErrors, PoolMetadataArgs, PoolType,
        };
    }
