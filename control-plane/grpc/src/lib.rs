...
/// Frontend GRPC module for the autogenerated common frontend node code.
pub(crate) mod frontend {
    #![allow(clippy::derive_partial_eq_without_eq)]
    tonic::include_proto!("v1.frontend_node");
    pub(crate) mod registration {
        #![allow(clippy::derive_partial_eq_without_eq)]
        tonic::include_proto!("v1.frontend_node.registration");
    }
}
