...
impl Specs {
    ...
    pub fn new(
        nexuses: impl IntoVec<crate::models::NexusSpec>,
        pools: impl IntoVec<crate::models::PoolSpec>,
        replicas: impl IntoVec<crate::models::ReplicaSpec>,
        volumes: impl IntoVec<crate::models::VolumeSpec>,
    ) -> Specs {
        Specs {
