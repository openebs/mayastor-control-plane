...
impl BlockDevice {
    ...
    pub fn new(
        available: impl Into<bool>,
        devlinks: impl IntoVec<String>,
        devmajor: impl Into<i32>,
        devminor: impl Into<i32>,
        devname: impl Into<String>,
        devpath: impl Into<String>,
        devtype: impl Into<String>,
        filesystem: impl Into<crate::models::BlockDeviceFilesystem>,
        model: impl Into<String>,
        partition: impl Into<crate::models::BlockDevicePartition>,
        size: impl Into<i64>,
    ) -> BlockDevice {
        BlockDevice {
