...
pub trait Pools: Clone {
    ...
    async fn get_node_pool(
        ...
        node_id: &str,
        pool_id: &str,
    ) -> Result<crate::models::Pool, Error<crate::models::RestJsonError>>;
    async fn get_node_pools(
        &self,
        id: &str,
    ) -> Result<Vec<crate::models::Pool>, Error<crate::models::RestJsonError>>;
    async fn get_pool(
        &self,
        pool_id: &str,
    ) -> Result<crate::models::Pool, Error<crate::models::RestJsonError>>;
    ...
    async fn put_node_pool(
        ...
        node_id: &str,
        pool_id: &str,
        create_pool_body: crate::models::CreatePoolBody,
    ) -> Result<crate::models::Pool, Error<crate::models::RestJsonError>>;
}
...
impl Pools for PoolsClient {
    ...
    async fn put_node_pool(
        ...
        let mut local_var_resp = if configuration.trace_requests {
            local_var_req_builder.send_json(&create_pool_body).await
        } else {
            local_var_req_builder
                .trace_request()
                .send_json(&create_pool_body)
                .await
        }?;
