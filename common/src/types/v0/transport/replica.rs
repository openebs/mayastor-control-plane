...
/// List Replicas Request
#[derive(Serialize, Deserialize, Default, Debug, Clone)]
#[serde(rename_all = "camelCase")]
pub struct ListReplicas {
    /// id of the io-engine instance
    pub node: NodeId,
    /// id of the pool
    pub poolname: Option<PoolId>,
    /// name of the replica
    pub name: Option<ReplicaName>,
}
